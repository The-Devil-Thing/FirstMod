package net.thedevilthing.firstmod.block.entity.renderer;
...
public class InfusionBlockEntityRenderer implements BlockEntityRenderer<InfuserBlockEntity> {


    public InfusionBlockEntityRenderer(BlockEntityRendererProvider.Context context) {
