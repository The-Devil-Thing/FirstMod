...
public class AddItemModifier extends LootModifier {
    public static final MapCodec<AddItemModifier> CODEC = RecordCodecBuilder.mapCodec(addItemModifierInstance -> LootModifier.codecStart(addItemModifierInstance)
